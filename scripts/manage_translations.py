...
def _tx_resource_for_name(name):
    ...
    return "taiga-contrib-subscriptions.{}".format(name)
...
You need transifex-client, install it.
 ...
 2. Create ~/.transifexrc file:
    ...
    parser = ArgumentParser(description="manage translations in taiga-contrib-subscriptions between the repo and transifex.",
